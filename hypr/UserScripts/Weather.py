...
# location_id que veio padrão:
#location_id = "bca47d1099e762a012b9a139c36f30a0b1e647f69c0c4ac28b537e7ae9c1c200"  # T#ODO
...
lugar = html_data("h1[class='CurrentConditions--location--1YWj_']").eq(0).text()
lugar = lugar.split(', ')[:2]
lugar = f'{lugar[0]}, {lugar[1]}'
...
from WeatherNextHours import get_next_hours


next_hours_text = f"<span bgcolor='black' bgalpha='20%'>{get_next_hours()}</span>"
...
try:
    with open(os.path.expanduser("~/.cache/.weather_next_hours_cache"), "w") as file:
        file.write(next_hours_text)
except:
    pass
